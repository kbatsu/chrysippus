# CONVENTIONS.md — persona skills for Aider
...
- **`ontario-bud`** — triggers: *"ontario bud"*, *"letterkenny mode"*, *"pitter patter"*, *"talk like wayne"*, *"/ontario-bud"*, *"/wayne"*
...
*Trigger phrases: `ontario bud`, `letterkenny mode`, `pitter patter`, `talk like wayne`, `/ontario-bud`, `/wayne`*
